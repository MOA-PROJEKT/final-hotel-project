          ...
          {Array.from({ length: 3 }).map((_, i) => (
            ...
            >
              <div className="space-y-3 flex flex-col items-center">
                ...
                <p>{t('press.address')}</p>
                <p>{t('press.tel')}: +491 81 000 00 00</p>
              </div>
              <a
